...
STRING_LITERAL(TM_tQrSTGoNVJJYsChrKn6xOw_8, "x index: $1 out of bounds for matrix: $2", 40);
STRING_LITERAL(TM_tQrSTGoNVJJYsChrKn6xOw_9, "Matrix( width:$1, height:$2, offset:$3 )", 40);
STRING_LITERAL(TM_tQrSTGoNVJJYsChrKn6xOw_10, "y index: $1 out of bounds for matrix: $2", 40);
static N_NIMCALL(void, Marker_tySequence_6MHxSSkCYafnfGYzxyCqtA)(void* p, NI op) {
...
N_LIB_PRIVATE N_NIMCALL(void, newMatrix_M0SbTQ7CK3cgtJ3Pxb1eRg)(NI width, NI height, tyObject_Matrix_5jfXleRjKMzj7p29cba2i9bg* Result) {
	...
	TM_tQrSTGoNVJJYsChrKn6xOw_4 = mulInt(width, height);
	unsureAsgnRef((void**) (&(*Result).data), newSeq_Vwp4M09ciGpSzWSD1pqtZ6w(((NI)chckRange((NI)(TM_tQrSTGoNVJJYsChrKn6xOw_4), ((NI) 0), ((NI) IL64(9223372036854775807))))));
	popFrame();
}
...
N_LIB_PRIVATE N_NIMCALL(void, newMatrix_WRyqL4rA9c9b9ckAdQys1qMYA)(NI width, NI height, tyObject_Matrix_Uogfi9b3606EsxiEmiGDiAw* Result) {
	...
	(*Result).height = height;
	nimln_(19, "matrix.nim");
	TM_tQrSTGoNVJJYsChrKn6xOw_5 = mulInt(width, height);
	unsureAsgnRef((void**) (&(*Result).data), newSeq_Ltn5D7x7AgJUEN0OQVkiEw(((NI)chckRange((NI)(TM_tQrSTGoNVJJYsChrKn6xOw_5), ((NI) 0), ((NI) IL64(9223372036854775807))))));
	popFrame();
}
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, dollar__BNdGsTV6ZFhDHZTIzaJY5Q)(tyObject_Matrix_Uogfi9b3606EsxiEmiGDiAw* self) {
	...
	result = nsuFormatVarargs(((NimStringDesc*) &TM_tQrSTGoNVJJYsChrKn6xOw_9), T1_, 3);
	popFrame();
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(void, set_dwKTQMqun8vrCrUIi6jcSg)(tyObject_Matrix_Uogfi9b3606EsxiEmiGDiAw* self, NI x, NI y, NIM_BOOL value) {
	NI x2;
	NI TM_tQrSTGoNVJJYsChrKn6xOw_6;
	NI y2;
	...
	TM_tQrSTGoNVJJYsChrKn6xOw_6 = addInt(x, (*self).offset.x);
	x2 = (NI)(TM_tQrSTGoNVJJYsChrKn6xOw_6);
	nimln_(38, "matrix.nim");
	TM_tQrSTGoNVJJYsChrKn6xOw_7 = addInt(y, (*self).offset.y);
	y2 = (NI)(TM_tQrSTGoNVJJYsChrKn6xOw_7);
	nimln_(39, "matrix.nim");
	{
		...
		asgnRefNoCycle((void**) (&(*e).Sup.message), nsuFormatVarargs(((NimStringDesc*) &TM_tQrSTGoNVJJYsChrKn6xOw_8), T7_, 2));
	...
	nimln_(42, "matrix.nim");
	{
		...
		asgnRefNoCycle((void**) (&(*e_2).Sup.message), nsuFormatVarargs(((NimStringDesc*) &TM_tQrSTGoNVJJYsChrKn6xOw_10), T14_, 2));
		nimln_(2806, "system.nim");
	...
	TM_tQrSTGoNVJJYsChrKn6xOw_11 = mulInt(y, (*self).width);
	TM_tQrSTGoNVJJYsChrKn6xOw_12 = addInt((NI)(TM_tQrSTGoNVJJYsChrKn6xOw_11), x);
	if ((NU)((NI)(TM_tQrSTGoNVJJYsChrKn6xOw_12)) >= (NU)((*self).data->Sup.len)) raiseIndexError();
	(*self).data->data[(NI)(TM_tQrSTGoNVJJYsChrKn6xOw_12)] = value;
	popFrame();
}
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, contains_Hvqkdr9bF9az9aNEuE3gnxkyw)(tyObject_Matrix_Uogfi9b3606EsxiEmiGDiAw* self, tyObject_Vec2_7SQP9azfryP3zjoOAafzI6g vec) {
	...
	NIM_BOOL T2_;
	NIM_BOOL T3_;
	nimfr_("contains", "matrix.nim");
	result = (NIM_BOOL)0;
	nimln_(68, "matrix.nim");
	TM_tQrSTGoNVJJYsChrKn6xOw_17 = addInt(vec.x, (*self).offset.x);
	x = (NI)(TM_tQrSTGoNVJJYsChrKn6xOw_17);
	nimln_(69, "matrix.nim");
	TM_tQrSTGoNVJJYsChrKn6xOw_18 = addInt(vec.y, (*self).offset.y);
	y = (NI)(TM_tQrSTGoNVJJYsChrKn6xOw_18);
	nimln_(70, "matrix.nim");
	T1_ = (NIM_BOOL)0;
	T2_ = (NIM_BOOL)0;
	T3_ = (NIM_BOOL)0;
	T3_ = (((NI) 0) <= x);
...
{	result = (NIM_BOOL)0;
	...
	TM_tQrSTGoNVJJYsChrKn6xOw_19 = addInt(x, (*self).offset.x);
	x2 = (NI)(TM_tQrSTGoNVJJYsChrKn6xOw_19);
	nimln_(27, "matrix.nim");
	TM_tQrSTGoNVJJYsChrKn6xOw_20 = addInt(y, (*self).offset.y);
	y2 = (NI)(TM_tQrSTGoNVJJYsChrKn6xOw_20);
	...
	TM_tQrSTGoNVJJYsChrKn6xOw_21 = mulInt(y, (*self).width);
	TM_tQrSTGoNVJJYsChrKn6xOw_22 = addInt((NI)(TM_tQrSTGoNVJJYsChrKn6xOw_21), x);
	if ((NU)((NI)(TM_tQrSTGoNVJJYsChrKn6xOw_22)) >= (NU)((*self).data->Sup.len)) raiseIndexError();
	result = (*self).data->data[(NI)(TM_tQrSTGoNVJJYsChrKn6xOw_22)];
	goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
	return result;
...
N_LIB_PRIVATE N_NIMCALL(tyTuple_Ye8PLO8qqXk1tek2VP9c0UQ, get_uvL9bK1KOZ240Zsp9cvalHnw)(tyObject_Matrix_5jfXleRjKMzj7p29cba2i9bg* self, NI x, NI y) {
	...
	NI TM_tQrSTGoNVJJYsChrKn6xOw_25;
	NI TM_tQrSTGoNVJJYsChrKn6xOw_26;
	nimfr_("get", "matrix.nim");
{	memset((void*)(&result), 0, sizeof(result));
	nimln_(26, "matrix.nim");
	TM_tQrSTGoNVJJYsChrKn6xOw_23 = addInt(x, (*self).offset.x);
	x2 = (NI)(TM_tQrSTGoNVJJYsChrKn6xOw_23);
	nimln_(27, "matrix.nim");
	TM_tQrSTGoNVJJYsChrKn6xOw_24 = addInt(y, (*self).offset.y);
	y2 = (NI)(TM_tQrSTGoNVJJYsChrKn6xOw_24);
	nimln_(28, "matrix.nim");
	{
		NIM_BOOL T3_;
		tyObject_IndexError_b0IIwghFQBADkB2c86kXQA* e;
	...
	LA12_: ;
	nimln_(34, "matrix.nim");
	TM_tQrSTGoNVJJYsChrKn6xOw_25 = mulInt(y, (*self).width);
	TM_tQrSTGoNVJJYsChrKn6xOw_26 = addInt((NI)(TM_tQrSTGoNVJJYsChrKn6xOw_25), x);
	if ((NU)((NI)(TM_tQrSTGoNVJJYsChrKn6xOw_26)) >= (NU)((*self).data->Sup.len)) raiseIndexError();
	result = (*self).data->data[(NI)(TM_tQrSTGoNVJJYsChrKn6xOw_26)];
	goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
	return result;
...
static TNimNode* TM_tQrSTGoNVJJYsChrKn6xOw_3[4];
...
TM_tQrSTGoNVJJYsChrKn6xOw_3[0] = &TM_tQrSTGoNVJJYsChrKn6xOw_0[6];
...
TM_tQrSTGoNVJJYsChrKn6xOw_3[1] = &TM_tQrSTGoNVJJYsChrKn6xOw_0[7];
...
TM_tQrSTGoNVJJYsChrKn6xOw_3[2] = &TM_tQrSTGoNVJJYsChrKn6xOw_0[8];
...
TM_tQrSTGoNVJJYsChrKn6xOw_3[3] = &TM_tQrSTGoNVJJYsChrKn6xOw_0[9];
...
TM_tQrSTGoNVJJYsChrKn6xOw_0[5].len = 4; TM_tQrSTGoNVJJYsChrKn6xOw_0[5].kind = 2; TM_tQrSTGoNVJJYsChrKn6xOw_0[5].sons = &TM_tQrSTGoNVJJYsChrKn6xOw_3[0];
